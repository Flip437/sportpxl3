...
ActiveRecord::Schema.define(version: 2021_05_14_101012) do
  ...
  create_table "email_requests", id: :bigint, default: nil, force: :cascade do |t|
    t.string "email"
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "pictures", id: :serial, force: :cascade do |t|
    ...
    t.string "image_content_type"
    t.string "direct_image_url"
    t.index ["edition_id"], name: "index_pictures_on_edition_id"
  end
  ...
  create_table "runners", id: :serial, force: :cascade do |t|
    ...
    t.index ["id_key"], name: "index_runners_on_id_key", unique: true
    t.index ["last_name", "first_name"], name: "index_runners_on_last_name_and_first_name"
    t.index ["real"], name: "index_runners_on_real"
  end
  ...
  create_table "scores", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["runner_id"], name: "index_scores_on_runner_id"
  end

  create_table "sportpics", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    t.integer "event_id"
    t.index ["event_id"], name: "index_sportpics_on_event_id"
    t.index ["user_id"], name: "index_sportpics_on_user_id"
  end
